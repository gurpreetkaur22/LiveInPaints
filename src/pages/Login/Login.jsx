  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fffdf9] via-[#fff5f8] to-[#ffedf3] pt-20">
      <div className="grid grid-cols-1 lg:grid-cols-2 min-h-screen">
        {/* Left Side - Headings and Image */}
        <div className="flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 lg:p-12 order-1 lg:order-1">
          <div className="text-center max-w-lg w-full">
            ...
            <div className="space-y-3 md:space-y-4 hidden sm:block">
              ...
              <div className="flex items-center justify-center gap-3 text-[#390F0F]">
                ...
                <span className="poppins-regular text-sm md:text-base">Quick and easy ordering</span>
              </div>
              <div className="flex items-center justify-center gap-3 text-[#390F0F]">
                <svg
                  className="w-4 h-4 md:w-5 md:h-5 text-[#FF5D8F] flex-shrink-0"
        ...
        <div className="flex flex-col justify-center items-center p-4 sm:p-6 md:p-8 lg:p-12 bg-white/30 backdrop-blur-sm order-2 lg:order-2">
